...
(function () {
  ...
  const nav = {
    fr: {
      ...
      minister: 'Mot du Ministre', president: 'Mot du Président', history: 'Histoire, mission et valeurs', values: 'Nos valeurs', governance: 'Gouvernance',
      ...
      adh_activeBody: 'Adhérent d\'office : tout le personnel actif du Département de l\'Agriculture, ainsi que leurs conjoints et enfants.',
      adh_orgsTitle: 'Organismes sous tutelle',
      adh_orgsBody: 'Adhésion au choix et sur demande pour le personnel des établissements sous tutelle du Département, leurs conjoints et enfants, après signature d\'une convention entre la FOS-Agri et l\'administration de l\'établissement.',
      adh_retraitesTitle: 'Retraités',
      adh_retraitesBody: 'Adhésion au choix pour les retraités du Département, après validation du montant de prélèvement mensuel auprès de la CMR.',
      adh_procedureTitle: 'Procédure d\'adhésion',
      adh_procIntro: 'Les pièces à fournir dépendent de votre situation.',
      adh_procActiveTitle: 'Personnel en activité',
      adh_procActiveIntro: 'Le personnel en activité est adhérent d\'office. Il doit fournir les pièces suivantes pour l\'activation de son adhésion :',
      adh_procActive1: 'Fiche d\'adhésion',
      adh_procActive2: 'Bulletin individuel d\'adhésion',
      adh_procActive3: 'Chèque barré ou RIB',
      adh_procActive4: 'Pièces justificatives des enfants et conjoints (copie du livret de famille ou de l\'acte de mariage, actes de naissance des enfants)',
      adh_procOrgsTitle: 'Organismes sous tutelle',
      adh_procOrgsBody: 'Procédure définie et arrêtée en concertation avec l\'administration des établissements sous tutelle concernés.',
      adh_ctaOrient: 'Demander une orientation',
      adh_procProlongTitle: 'Prolongation d\'adhésion pour futurs retraités',
      adh_procProlong1: 'Demande de prolongation d\'adhésion après la mise en retraite, précisant le numéro de téléphone et les adresses email et postale',
      adh_procProlong2: 'Autorisation de précompte légalisée, en deux copies, à transmettre via l\'administration (bordereau) 3 mois avant la date d\'effet de la sortie de service',
      adh_procRetraitesTitle: 'Retraités',
      adh_procRetraites1: 'Demande d\'adhésion à la FOS-Agri',
      adh_procRetraites2: 'Fiche de demande d\'adhésion, précisant le numéro de téléphone et l\'adresse email et postale',
      adh_procRetraites3: 'Chèque barré ou attestation de RIB',
      adh_procRetraites4: 'Attestation de pension',
      adh_procRetraites5: 'Autorisation de précompte, en deux copies',
      adh_procRetraites6: 'Pièces justificatives des enfants et conjoints (copie du livret de famille ou de l\'acte de mariage, actes de naissance des enfants)',
      adh_download: 'Télécharger',
      adh_cotTitle: 'Cotisations',
      adh_cotBody: 'Le montant de la cotisation mensuelle dépend de l\'échelle ou du grade de l\'adhérent.',
      adh_cot1: 'Catégorie 1 : Echelles 6 et 7', adh_cot1Amount: '20.00 DH',
      adh_cot2: 'Catégorie 2 : Echelles 8 et 9', adh_cot2Amount: '30.00 DH',
      adh_cot3: 'Catégorie 3 : Echelle 10', adh_cot3Amount: '45.00 DH',
      adh_cot4: 'Catégorie 4 : Echelle 11', adh_cot4Amount: '70.00 DH',
      adh_cot5: 'Catégorie 5 : Hors Echelle Premier Grade', adh_cot5Amount: '100.00 DH',
      adh_cot6: 'Catégorie 6 : Hors Echelle Grade Principal', adh_cot6Amount: '120.00 DH',
    ...
    ar: {
      ...
      minister: 'كلمة الوزير', president: 'كلمة الرئيس', history: 'التاريخ، المهمة والقيم', values: 'قيمنا', governance: 'الحكامة والتنظيم',
      ...
      adh_activeBody: 'منخرطون تلقائيا: جميع الموظفين العاملين بوزارة الفلاحة، وكذا أزواجهم وأبناؤهم.',
      adh_orgsTitle: 'المؤسسات تحت الوصاية',
      adh_orgsBody: 'انخراط اختياري وبطلب لموظفي المؤسسات الخاضعة لوصاية الوزارة، وأزواجهم وأبناؤهم، بعد توقيع اتفاقية بين FOS-Agri وإدارة المؤسسة المعنية.',
      adh_retraitesTitle: 'المتقاعدون',
      adh_retraitesBody: 'انخراط اختياري لمتقاعدي الوزارة، بعد المصادقة على مبلغ الاقتطاع الشهري لدى الصندوق المغربي للتقاعد.',
      adh_procedureTitle: 'مسطرة الانخراط',
      adh_procIntro: 'تختلف الوثائق المطلوبة حسب وضعيتكم.',
      adh_procActiveTitle: 'الموظفون العاملون',
      adh_procActiveIntro: 'الموظف العامل منخرط تلقائيا. يجب عليه تقديم الوثائق التالية لتفعيل انخراطه:',
      adh_procActive1: 'بطاقة الانخراط',
      adh_procActive2: 'نشرة فردية للانخراط',
      adh_procActive3: 'شيك مسطر أو رقم الحساب البنكي (RIB)',
      adh_procActive4: 'وثائق إثبات الأبناء والأزواج (نسخة من دفتر العائلة أو عقد الزواج، وعقود ازدياد الأبناء)',
      adh_procOrgsTitle: 'المؤسسات تحت الوصاية',
      adh_procOrgsBody: 'مسطرة محددة ومتفق عليها بتنسيق مع إدارة المؤسسات المعنية الخاضعة للوصاية.',
      adh_ctaOrient: 'طلب التوجيه',
      adh_procProlongTitle: 'تمديد الانخراط للمتقاعدين المستقبليين',
      adh_procProlong1: 'طلب تمديد الانخراط بعد الإحالة على التقاعد، مع تحديد رقم الهاتف والعنوان الإلكتروني والبريدي',
      adh_procProlong2: 'إذن بالاقتطاع مصادق عليه، في نسختين، يُرسل عبر الإدارة (بيان إرسال) 3 أشهر قبل تاريخ سريان انتهاء الخدمة',
      adh_procRetraitesTitle: 'المتقاعدون',
      adh_procRetraites1: 'طلب الانخراط في FOS-Agri',
      adh_procRetraites2: 'بطاقة طلب الانخراط، مع تحديد رقم الهاتف والعنوان الإلكتروني والبريدي',
      adh_procRetraites3: 'شيك مسطر أو شهادة الحساب البنكي (RIB)',
      adh_procRetraites4: 'شهادة التقاعد',
      adh_procRetraites5: 'إذن بالاقتطاع، في نسختين',
      adh_procRetraites6: 'وثائق إثبات الأبناء والأزواج (نسخة من دفتر العائلة أو عقد الزواج، وعقود ازدياد الأبناء)',
      adh_download: 'تحميل',
      adh_cotTitle: 'الاشتراكات',
      adh_cotBody: 'يتحدد مبلغ الاشتراك الشهري حسب سلم أو رتبة المنخرط.',
      adh_cot1: 'الفئة 1: السلمان 6 و7', adh_cot1Amount: '20.00 درهم',
      adh_cot2: 'الفئة 2: السلمان 8 و9', adh_cot2Amount: '30.00 درهم',
      adh_cot3: 'الفئة 3: السلم 10', adh_cot3Amount: '45.00 درهم',
      adh_cot4: 'الفئة 4: السلم 11', adh_cot4Amount: '70.00 درهم',
      adh_cot5: 'الفئة 5: خارج السلم، الدرجة الأولى', adh_cot5Amount: '100.00 درهم',
      adh_cot6: 'الفئة 6: خارج السلم، الرتبة الرئيسية', adh_cot6Amount: '120.00 درهم',
    ...
    zgh: {
      ...
      minister: 'ⴰⵡⴰⵍ ⵏ ⵓⵎⵏⵣⴰⵡ', president: 'ⴰⵡⴰⵍ ⵏ ⵓⵙⵍⵡⴰⵢ', history: 'ⴰⵎⵣⵔⵓⵢ, ⵜⴰⵎⴰⵙⵜ ⴷ ⵉⵎⴰⵙⵙⴰⵏ', values: 'ⵜⵉⵏⵉⵍⴰ', governance: 'ⵜⴰⴳⵓⵔⵉ ⴷ ⵜⵎⵙⵙⵓⴷⵙⵜ',
      ...
      adh_activeBody: 'ⴰⵎⵓⵏ ⵙ ⵉⵎⵉⴽ: ⴰⴽⴽⵯ ⵉⵎⵇⵇⵔⴰⵏⴻⵏ ⵏ ⵜⵎⴰⵡⴰⵙⵜ ⵏ ⵜⴼⵍⴰⵃⵜ, ⴷ ⵉⵙⵍⵉⵡⵉⵏ ⴷ ⵉⵙⴻⵍⵎⵉ ⵏⵏⵙⴻⵏ.',
      adh_orgsTitle: 'ⵜⵉⵎⵙⵙⵓⵔⵉⵏ ⵙⴷⴷⴰⵡ ⵏ ⵓⴱⴷⴷⵉ',
      adh_orgsBody: 'ⴰⵎⵓⵏ ⵙ ⵓⴼⵔⴰⵏ ⴷ ⵓⵙⵓⵜⵔ ⵉ ⵉⵎⵇⵇⵔⴰⵏⴻⵏ ⵏ ⵜⵎⵙⵙⵓⵔⵉⵏ ⵙⴷⴷⴰⵡ ⵏ ⵓⴱⴷⴷⵉ, ⴷ ⵉⵙⵍⵉⵡⵉⵏ ⴷ ⵉⵙⴻⵍⵎⵉ ⵏⵏⵙⴻⵏ, ⴷⴻⴼⴼⵉⵔ ⵏ ⵓⵙⵉⵔⵎ ⵏ ⵓⵎⵢⴰⴽ ⵊⴻⵔ FOS-Agri ⴷ ⵜⵏⵙⵙⵓⴷⵙⵜ ⵏ ⵜⵎⵙⵙⵓⵔⵜ.',
      adh_retraitesTitle: 'ⵉⵎⴰⵙⵙⵉⵏⴻⵏ',
      adh_retraitesBody: 'ⴰⵎⵓⵏ ⵙ ⵓⴼⵔⴰⵏ ⵉ ⵉⵎⴰⵙⵙⵉⵏⴻⵏ ⵏ ⵜⵎⴰⵡⴰⵙⵜ, ⴷⴻⴼⴼⵉⵔ ⵏ ⵓⵙⴻⴼⵙⵉ ⵏ ⵜⵡⵙⵉⵡⵜ ⵏ ⵓⵢⵢⵓⵔ ⴳ ⵓⵙⵏⴷⵓⵇ ⴰⵎⵖⵔⵉⴱⵉ ⵏ ⵓⵔⵜⵉⵔⵉ.',
      adh_procedureTitle: 'ⵜⴰⵎⵙⵙⴰⵔⵜ ⵏ ⵓⵎⵓⵏ',
      adh_procIntro: 'ⵉⵎⴰⵙⵙⵉⵏⴻⵏ ⵉⵜⵜⵓⵙⵓⵜⵔⴻⵏ ⵎⵢⵉⵎⴽⵉⵏ ⵙ ⵓⵎⴻⵥⵍⵓ ⵏⵏⵓⵏ.',
      adh_procActiveTitle: 'ⵉⵎⵇⵇⵔⴰⵏⴻⵏ ⵉⵜⵜⵓⵙⴽⴰⵔⵏ',
      adh_procActiveIntro: 'ⴰⵎⵇⵇⵔⴰⵏ ⵉⵜⵜⵓⵙⴽⴰⵔⵏ ⵢⴻⵜⵜⵓⵎⵓⵏ ⵙ ⵉⵎⵉⴽ. ⵢⴻⵙⵙⴻⴼⴽ ⴰⴷ ⵢⴰⵡⵢ ⵉⵎⴰⵙⵙⵉⵏⴻⵏ ⴰⴷ ⵉ ⵓⵙⴻⴽⵙⴻⵎ ⵏ ⵓⵎⵓⵏ ⵏⵏⵙ:',
      adh_procActive1: 'ⵜⴰⴽⴰⵔⴹⴰ ⵏ ⵓⵎⵓⵏ',
      adh_procActive2: 'ⵜⴰⵏⴰⵙⵙⵉⵎⵜ ⵜⴰⵎⴰⵏⴰⵡⵜ ⵏ ⵓⵎⵓⵏ',
      adh_procActive3: 'ⵛⵉⴽ ⵉⵙⵎⴻⵟⵟⴻⵔⵏ ⵏⵉⵖ RIB',
      adh_procActive4: 'ⵉⵎⴰⵙⵙⵉⵏⴻⵏ ⵏ ⵓⵙ⵻ⵏⵜⴰⵢ ⵏ ⵉⵙⴻⵍⵎⵉ ⴷ ⵉⵙⵍⵉⵡⵉⵏ (ⵜⴰⴽⵓⵏⵔⵙⵜ ⵏ ⵓⴽⵜⴰⴱ ⵏ ⵜⵡⴰⵛⵓⵍⵜ ⵏⵉⵖ ⵜⴰⴽⴰⵔⴹⴰ ⵏ ⵣⵡⴰⵊ, ⵜⵉⴽⴰⵔⴹⵉⵡⵉⵏ ⵏ ⵜⵍⴰⵍⵉⵜ ⵏ ⵉⵙⴻⵍⵎⵉ)',
      adh_procOrgsTitle: 'ⵜⵉⵎⵙⵙⵓⵔⵉⵏ ⵙⴷⴷⴰⵡ ⵏ ⵓⴱⴷⴷⵉ',
      adh_procOrgsBody: 'ⵜⴰⵎⵙⵙⴰⵔⵜ ⵜⵜⵓⵙⴻⴳⵎⵉⵜ ⴷ ⵜⵜⵓⵙⵎⴻⵛ ⵙ ⵓⵎⵢⴰⵡⴰⴹ ⴷ ⵜⵏⵙⵙⵓⴷⵙⵜ ⵏ ⵜⵎⵙⵙⵓⵔⵉⵏ ⵉⵎⵢⴰⴳⴻⵏ ⵙⴷⴷⴰⵡ ⵏ ⵓⴱⴷⴷⵉ.',
      adh_ctaOrient: 'ⴰⵙⵙⵓⵎⵔ ⵏ ⵜⵉⵏⴰⵙⵜ',
      adh_procProlongTitle: 'ⴰⵙⵉⴷⴼ ⵏ ⵓⵎⵓⵏ ⵉ ⵉⵎⴰⵙⵙⵉⵏⴻⵏ ⵉⴹⴼⴰⵕⵏ',
      adh_procProlong1: 'ⴰⵙⵓⵜⵔ ⵏ ⵓⵙⵉⴷⴼ ⵏ ⵓⵎⵓⵏ ⴷⴻⴼⴼⵉⵔ ⵏ ⵓⵔⵜⵉⵔⵉ, ⵙ ⵓⵎⵍⵓⴳⵎ ⵏ ⵓⵎⵢⴰⵡⴰⴹ, ⵜⵉⵏⴰⵢⵍⵉⵏ ⵏ ⵉⵎⴰⵢⵍ ⴷ ⵓⵙⴻⴼⵜⴰ',
      adh_procProlong2: 'ⴰⴷⵓⴼ ⵏ ⵓⵙⴻⴽⵙⴻⵎ ⵢⴻⵜⵜⵓⵙⵎⴻⵛ, ⵙ ⵙⵉⵏ ⵜⴻⴽⵓⵏⵔⵙⵉⵏ, ⴰⴷ ⵢⴰⵣⵏ ⵙ ⵜⵏⵙⵙⵓⴷⵙⵜ ⴽⵕⴰⴹ ⵡⴰⵢⵢⵓⵔⴻⵏ ⵇⴱⵍ ⵏ ⵡⴰⵙⵙ ⵏ ⵓⴼⴼⵓⵖ ⵏ ⵓⵎⵖⴰⵔ',
      adh_procRetraitesTitle: 'ⵉⵎⴰⵙⵙⵉⵏⴻⵏ',
      adh_procRetraites1: 'ⴰⵙⵓⵜⵔ ⵏ ⵓⵎⵓⵏ ⴳ FOS-Agri',
      adh_procRetraites2: 'ⵜⴰⴽⴰⵔⴹⴰ ⵏ ⵓⵙⵓⵜⵔ ⵏ ⵓⵎⵓⵏ, ⵙ ⵓⵎⵍⵓⴳⵎ ⵏ ⵓⵎⵢⴰⵡⴰⴹ, ⵜⵉⵏⴰⵢⵍⵉⵏ ⵏ ⵉⵎⴰⵢⵍ ⴷ ⵓⵙⴻⴼⵜⴰ',
      adh_procRetraites3: 'ⵛⵉⴽ ⵉⵙⵎⴻⵟⵟⴻⵔⵏ ⵏⵉⵖ ⵜⴰⵙⵎⴻⴽⵜⴰ ⵏ RIB',
      adh_procRetraites4: 'ⵜⴰⵙⵎⴻⴽⵜⴰ ⵏ ⵓⵔⵜⵉⵔⵉ',
      adh_procRetraites5: 'ⴰⴷⵓⴼ ⵏ ⵓⵙⴻⴽⵙⴻⵎ, ⵙ ⵙⵉⵏ ⵜⴻⴽⵓⵏⵔⵙⵉⵏ',
      adh_procRetraites6: 'ⵉⵎⴰⵙⵙⵉⵏⴻⵏ ⵏ ⵓⵙ⵻ⵏⵜⴰⵢ ⵏ ⵉⵙⴻⵍⵎⵉ ⴷ ⵉⵙⵍⵉⵡⵉⵏ (ⵜⴰⴽⵓⵏⵔⵙⵜ ⵏ ⵓⴽⵜⴰⴱ ⵏ ⵜⵡⴰⵛⵓⵍⵜ ⵏⵉⵖ ⵜⴰⴽⴰⵔⴹⴰ ⵏ ⵣⵡⴰⵊ, ⵜⵉⴽⴰⵔⴹⵉⵡⵉⵏ ⵏ ⵜⵍⴰⵍⵉⵜ ⵏ ⵉⵙⴻⵍⵎⵉ)',
      adh_download: 'ⴰⵙⵉⴹⴻⵏ',
      adh_cotTitle: 'ⵜⵉⵡⵙⵉⵡⵉⵏ',
      adh_cotBody: 'ⴰⴹⵕⵉⵚ ⵏ ⵜⵡⵙⵉⵡⵜ ⵏ ⵓⵢⵢⵓⵔ ⵢⴻⵜⵜⴰⵡⵉ ⵙ ⵓⵙⴻⵍⵎⵉ ⵏⵉⵖ ⵜⴰⵔⵓⵜⴱⴰ ⵏ ⵓⵎⵓⵏ.',
      adh_cot1: 'ⵜⴰⵏⵙⵙⴰ 1: ⵉⵙⴻⵍⵎⴰⵏ 6 ⴷ 7', adh_cot1Amount: '20.00 ⴷⵔ',
      adh_cot2: 'ⵜⴰⵏⵙⵙⴰ 2: ⵉⵙⴻⵍⵎⴰⵏ 8 ⴷ 9', adh_cot2Amount: '30.00 ⴷⵔ',
      adh_cot3: 'ⵜⴰⵏⵙⵙⴰ 3: ⴰⵙⴻⵍⵎⵉ 10', adh_cot3Amount: '45.00 ⴷⵔ',
      adh_cot4: 'ⵜⴰⵏⵙⵙⴰ 4: ⴰⵙⴻⵍⵎⵉ 11', adh_cot4Amount: '70.00 ⴷⵔ',
      adh_cot5: 'ⵜⴰⵏⵙⵙⴰ 5: ⴱⴻⵕⵕⴰ ⵏ ⵓⵙⴻⵍⵎⵉ, ⵜⴰⵔⵓⵜⴱⴰ ⵜⴰⵎⴻⵣⵡⴰⵔⵓⵜ', adh_cot5Amount: '100.00 ⴷⵔ',
      adh_cot6: 'ⵜⴰⵏⵙⵙⴰ 6: ⴱⴻⵕⵕⴰ ⵏ ⵓⵙⴻⵍⵎⵉ, ⵜⴰⵔⵓⵜⴱⴰ ⵜⴰⵎⴻⵇⵇⵔⴰⵏⵜ', adh_cot6Amount: '120.00 ⴷⵔ',
